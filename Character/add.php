...
if (isset($_POST['update'])) {
    ...
    $sql = "UPDATE characters SET name = ?, anime_id = ?, description = ?, image_url = ?, voice_actor_english = ?, voice_actor_japanese = ? WHERE id = ?";
    $stmt = $conn->prepare($sql);
...
<body>
    ...
    <form method="POST" action="edit.php">
        ...
        <input type="text" name="voice_actor_japanese" value="<?php echo htmlspecialchars($row['voice_actor_japanese']); ?>" required><br><br>
