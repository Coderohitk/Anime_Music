    ...
    <ul class="list-group">
        <?php while ($anime = $anime_result->fetch_assoc()): ?>
            <li class="list-group-item d-flex align-items-center">
                ...
                <img src="uploads/<?php echo $anime['cover_image']; ?>" alt="<?php echo $anime['title']; ?>" class="img-thumbnail" style="width: 100px; height: 100px; margin-right: 10px;">
                <!-- Display anime title with a link -->
                <a href="music_list.php?anime_id=<?php echo $anime['id']; ?>" class="fs-4">
